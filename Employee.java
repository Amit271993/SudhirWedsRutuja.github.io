...
public class Employee
{
	...
	public String toString() {
		return "Employee [EMP_NO=" + EMP_NO + ", FIRST_NAME=" + FIRST_NAME + ", MID_INIT=" + MID_INIT + ", LAST_NAME="
				+ LAST_NAME + ", DEPT=" + DEPT + ", PHONE_NO=" + PHONE_NO + ", HIRE_DATE=" + HIRE_DATE + ", JOB_TITLE="
				+ JOB_TITLE + ", EMP_LEVEL=" + EMP_LEVEL + "]";
	}
